-- Apply Overall Assessments Migration
-- Run this in your Supabase Dashboard → SQL Editor

-- Migration 1: Create overall_assessments table
...
-- Verification query (run this separately to confirm)
-- SELECT table_name FROM information_schema.tables WHERE table_name = 'overall_assessments';
