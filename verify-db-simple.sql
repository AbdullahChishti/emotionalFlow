-- Simple Database Verification Query
-- This query checks only the tables that actually exist
...
-- 7. Check if profiles table has proper foreign key constraints
SELECT 
    tc.table_name,
    tc.constraint_name,
    tc.constraint_type,
...
-- 8. Check recent activity (last 24 hours)
SELECT 
